...
import logo from "../assets/LEGO_logo.png";
      ...
      <footer>
        <div className="flex h-[320px]">
          <div>
            ...
            <p className="text-gray-500 mr-[136px]">
          ...
          <div>
            <ul>
              ...
              <input
                className="w-[200px] border-b-2 mr-[11px] cursor-pointer"
                type="text"
                placeholder="Enter Your Email Address"
              />
              <button className="text-black px-2 py-1 rounded-md border-b-2 uppercase">
                Subscribe
              </button>
            </ul>
          </div>
